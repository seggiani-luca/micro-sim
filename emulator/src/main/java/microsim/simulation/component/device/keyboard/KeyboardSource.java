...
public class KeyboardSource {
  ...
  public static final Map<Integer, Byte> set1 = Map.ofEntries(
          ...
          // symbols
          Map.entry(KeyEvent.VK_BACK_SLASH, (byte) 0x41),
          Map.entry(KeyEvent.VK_QUOTE, (byte) 0x42),
          Map.entry(KeyEvent.getExtendedKeyCodeForChar('ì'), (byte) 0x43),
          Map.entry(KeyEvent.VK_PLUS, (byte) 0x44),
          Map.entry(KeyEvent.VK_OPEN_BRACKET, (byte) 0x45),
          Map.entry(KeyEvent.VK_CLOSE_BRACKET, (byte) 0x46),
          Map.entry(KeyEvent.VK_AT, (byte) 0x47),
          Map.entry(KeyEvent.VK_NUMBER_SIGN, (byte) 0x48),
          Map.entry(KeyEvent.VK_LESS, (byte) 0x49),
          Map.entry(KeyEvent.VK_COMMA, (byte) 0x4A),
          Map.entry(KeyEvent.VK_PERIOD, (byte) 0x4B),
          Map.entry(KeyEvent.VK_MINUS, (byte) 0x4C)
  );
  ...
  private void handleKeyEvent(KeyEvent e, Map<Integer, Byte> set, boolean breakCode) {
    ...
    Byte code = set.get(e.getExtendedKeyCode());
    if (code == null) {
      return;
    }
