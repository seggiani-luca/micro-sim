...
/**
 * SimulationEvent that signals a {@link microsim.simulation.component.device.video.VideoDevice} has finished
 * rendering to frame buffer
 */
public class FrameEvent extends SimulationEvent {

  /**
   * Frame buffer of the {@link microsim.simulation.component.device.video.VideoDevice} that finished rendering
   */
