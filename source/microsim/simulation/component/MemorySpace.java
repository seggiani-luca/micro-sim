...
/**
 * Implements a memory space as a (to outside users) contiguous array of byte
 * locations. Memory is divided in three regions:
 * <ol>
 * <li>EPROM: contains program code and data at startup.</li>
 * <li>RAM: for general access. </li>
 * <li>VRAM: gets rendered to video on
 * {@link microsim.simulation.component.VideoDevice#render()} calls.</li>
 * </ol>
 */
public class MemorySpace extends SimulationComponent {
    ...
    /**
     * Signals that the memory space is driving the bus, and should release it
     ...
     * and the EPROM data it should load in the EPROM region.
     *
    ...
    /**
     * Steps by handling read/write operations seen on bus. Bus protocol is the
     * following:
     * <ul>
     * <li>If {@link microsim.simulation.component.Bus#targetSpace} is not low,
     * ignore any operation.</li>
     * <li>
     * If {@link microsim.simulation.component.Bus#readEnable} is high, start a
     * read operation:
     * <ol>
     * <li>Read address from
     * {@link microsim.simulation.component.Bus#addressLine}.</li>
     * <li>Read data at address.</li>
     * <li>Drive {@link microsim.simulation.component.Bus#dataLine} for 1
     * simulation step.</li>
     * </ol>
     * </li>
     * <li>
     * If {@link microsim.simulation.component.Bus#writeEnable} is high, start a
     * write operation:
     * <ol>
     * <li>Read address from
     * {@link microsim.simulation.component.Bus#addressLine} and data from
     ...
     * {@link microsim.simulation.component.Bus#writeEnable} are high, raises an
     * exception.
     */
    @Override
    public void step() {
    ...
    /**
     * Reads from memory space at a given address. This is not meant to be used
     * by other simulation components, but by this class and
     * {@link microsim.ui.DebugShell} objects displaying shells.
     *
    ...
    /**
     * Writes to memory space at a given address. Usage is same as
     * {@link #readMemory(char)}.
     *
     ...
     * {@link microsim.simulation.component.VideoDevice} for direct VRAM
     * accesses when rendering to frame buffer.
     *
