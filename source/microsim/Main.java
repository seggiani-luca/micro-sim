...
public class Main {
   ...
   */
  private static String epromDataPath;
  ...
  private static byte[] getSimulationData(String[] args) {
    ...
    // get EPROM data path
    epromDataPath = getArgument(args, EPROM_TAG);
    if (epromDataPath == null) {
      // path must be specified
      System.err.println("Please specify an object data path with argument -e <object_data_path>");
      System.exit(1);
    }
